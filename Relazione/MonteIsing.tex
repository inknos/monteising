...
\\
 \textbf{Ising Model Simulation in arbitrary dimensions}}
...
well studied in Statistical Mechanics.\\
Born to describe ferromagnetism phenomena \\
it can easily generalize the concept of collective effects of single interacting couples\\
it became the core of the physics of complex systems.  \\
In the last decades computational methods have been applied to search a numerical solution for the Ising model in 3 dimensions\\
the lack of an analytical solution for the 3D model shows the necessity of Monte Carlo methods and 
outlines the purpose this work wants to pursuit\\
\\

Monte Carlo methods are \\
Metropolis is \\

 rooted in telecommunication theory and, informally speaking, it expresses the idea of data transfer between the principal telecommunication line and the user in the last (physical) mile of the network.  This can be translate in transportation engineering in the problem of goods delivery through the last part of the journey between producer and customer, which this work is about.
