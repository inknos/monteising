...

{
  ...
  const unsigned int lattice_dimension = 2; // this way a 10x10 lattice is created
  const unsigned int number_of_lattices = 5; // simulation performed simultaneously on 5 lattices
  ...
  SimulationLattice s(lattice_size,
		      lattice_dimension,
		      number_of_lattices,
		      simulation_file,
		      iter_pre_simulation,
